...
public class ScoreServiceImpl implements ScoreService {
    ...
    @Override
    public int addObScore(ScoreWork scoreWork) {
        return scoreMapper.addObScore(scoreWork);
    }
    ...
    @Override
    public List<Score> findByPaper(Integer paperId) {
        return scoreMapper.findByPaper(paperId);
    }
    ...
    @Override
    public int updateMarkingById(Integer score, Integer id) {
        return scoreMapper.updateMarkingById(score, id);
    }

    @Override
    public int updateScoreWorkById(Integer score, Integer id) {
        return scoreMapper.updateScoreWorkById(score, id);
    }
}
