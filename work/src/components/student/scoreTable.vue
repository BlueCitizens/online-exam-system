  ...
  <div class="table">
    ...
    <section class="content-el">
      <el-table ref="filterTable" :data="score" v-loading="loading">
        ...
        <el-table-column prop="description" label="作业名称"></el-table-column>
        <el-table-column prop="subject" label="课程"></el-table-column>
        <el-table-column prop="obScore" label="客观题" width="100"></el-table-column>
        <el-table-column prop="suScore" label="主观题" width="100"></el-table-column>
