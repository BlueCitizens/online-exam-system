  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: '/workDescription', //考试管理功能描述
          component: () => import('@/views/teacher/work/workDescription')
        },
        {
        ...
        {
          path: '/selectWork', //查询所有考试
          component: () => import('@/views/teacher/work/selectWork')
        },
        {
        ...
        {
          path: '/addWork', //添加作业
          component: () => import('@/views/teacher/work/addWork')
        },
        {
    ...
    {path: '/work/marking',component: () => import('@/views/teacher/work/marking')},
    {
      path: '/student',
      component: () => import('@/components/student/index'),
      children: [
        {path: "/", component: () => import('@/components/student/work/myWork')},
        ...
        {path: '/workMsg', component: () => import('@/components/student/work/workMsg')},
    ...
    {path: '/work/answer', component: () => import('@/components/student/work/answer')}
  ]
})
